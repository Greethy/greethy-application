...
final CustomLoader kScreenLoader = CustomLoader();
...
class Utility {
  ...
  static void logEvent(String event, {Map<String, dynamic>? parameter}) {
    if (!kReleaseMode) print("[EVENT]: $event");
  }
  ...
  // static Future<Uri> createLinkToShare(BuildContext context, String id, {required SocialMetaTagParameters socialMetaTagParameters}) async {
