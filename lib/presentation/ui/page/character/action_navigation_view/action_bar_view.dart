...
class ActionBarView extends StatefulWidget {
  ...
  @override
  _ActionBarViewState createState() => _ActionBarViewState();
}

class _ActionBarViewState extends State<ActionBarView> with TickerProviderStateMixin {
  AnimationController? animationController;

  @override
  void initState() {
    print("start action bar");
    animationController = AnimationController(
      vsync: this,
    ...
    return AspectRatio(
      ...
      child: Center(
        child: InkWell(
          ...
          onTap: () {
            print("ontap " + widget.tabIconData!.imagePath + widget.tabIconData!.isSelected.toString());
