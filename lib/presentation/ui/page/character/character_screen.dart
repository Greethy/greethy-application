...
import 'package:greethy_application/presentation/ui/flare_character/penguin.dart';
...
class _CharacterScreenState extends State<CharacterScreen> with TickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    // todo: phát triển ứng dụng với chế độ sáng trước, sau sẽ làm thêm tự động thay đổi chế độ sáng tối với thời gian trong ngày
          ...
          if (!snapshot.hasData) {
            ...
            return Padding(
              ...
              child: Column(
                ...
                children: <Widget>[
                  appBar(),
                  // todo: đoạn này sẽ kế thừa cho các nút bấm xung quanh kawa
                  // Expanded(
