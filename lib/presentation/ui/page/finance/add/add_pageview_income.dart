                  ...
                  Container(
                    ...
                    child: Container(
                      ...
                      child: Stack(
                        children: [
                          _itemImage != null
                              ? Image.file(_itemImage!, fit: BoxFit.fill, width: MediaQuery.of(context).size.width)
                              : Container(
                            color: Colors.amber,
                          ),
                          Center(
                  ...
                  Container(
                    ...
                    child: Container(
                      ...
                      child: Stack(
                        children: [
                          _billImage != null
                              ? Image.file(_billImage!, fit: BoxFit.fill, width: MediaQuery.of(context).size.width)
                              : Container(
                            color: Colors.grey,
                          ),
                          Center(
