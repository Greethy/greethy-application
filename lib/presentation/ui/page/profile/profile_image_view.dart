...
class ProfileImageView extends StatelessWidget {
  ...
  static Route<T> getRoute<T>(String avatar) {
    return SlideLeftRoute<T>(builder: (BuildContext context) => ProfileImageView(avatar: avatar));
  }
  ...
  Widget build(BuildContext context) {
    const List<Choice> choices = <Choice>[
      ...
      Choice(title: 'Open in browser', icon: Icons.open_in_browser, isEnable: true),
                ...
                return PopupMenuItem<Choice>(
                    ...
                    child: Text(choice.title,
                        style: TextStyles.textStyle14.copyWith(
                          color: choice.isEnable ? AppColor.secondary.withOpacity(.9) : AppColor.lightGrey,
                        )));
              }).toList();
            },
          ),
