...
//   }
//
//   Future<File> writeToFile(ByteData dataDev, String path) {
//     final buffer = dataDev.buffer;
//     return File(path).writeAsBytes(
//         buffer.asUint8List(dataDev.offsetInBytes, dataDev.lengthInBytes));
//   }
//
//   @override
...
//                   child: QrImageView(
//                     dataDev: "fwitter/profile/${widget.user.userId}",
//                     embeddedImageStyle:
...
//                 ),
//               ),
//               CircularImage(path: widget.user.avatar, height: 50),
//             ],
//           ),
//         ),
//       ),
