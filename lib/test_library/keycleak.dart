...
class FlutterKeycloakExampleState extends State<FlutterKeycloakExample> {
  ...
  void printStorage() {
    getCredentials().then((credentials) {
      setState(() {
        _currentPrefs = '${getConfiguration()}\n\n${getTokens()}\n\n$credentials';
      });
    });
  }
          ...
          child: _conf != null
                    ...
                    ElevatedButton(
                      onPressed: () async {
                        await _flutterKeycloak.login(
                          ...
                          scope: _scopeController.text != '' ? _scopeController.text : 'offline_access',
                        );
                        printStorage();
                      },
              ...
              : Column(
                  children: [
                    ...
                    ElevatedButton(
                      onPressed: () => _flutterKeycloak.getConf(_confController.text).then((conf) => setState(() => _conf = conf)),
