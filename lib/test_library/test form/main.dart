              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    Container(
                      decoration: const BoxDecoration(color: Colors.white, borderRadius: BorderRadius.all(Radius.circular(cornerRadius))),
                      child: Padding(
                          ...
                          child: Column(
                            ...
                            children: <Widget>[
                              TrackingTextInput(
                                ...
                                onCaretMoved: _characterController.lookAt,
                              ...
                              SigninButton(
                                child: const Text("Sign In", style: TextStyle(fontFamily: "RobotoMedium", fontSize: 16, color: Colors.white)),
                                onPressed: _login,
                              )
                            ],
                          ),
