...
class BarChart4 extends StatefulWidget {
  ...
  final Color dark = GreethyColor.darkGreen;
  final Color light = GreethyColor.alabaster;
  final Color normal = GreethyColor.bondiBlue;

  @override
  State<StatefulWidget> createState() => BarChartSample4State();
}

class BarChartSample4State extends State<BarChart4> {
                ...
                BarChartData(
                  ...
                  gridData: FlGridData(
                    ...
                    getDrawingHorizontalLine: (value) => FlLine(
                      color: GreethyColor.kawa_green.withOpacity(0.1),
                      strokeWidth: 1,
                    ),
