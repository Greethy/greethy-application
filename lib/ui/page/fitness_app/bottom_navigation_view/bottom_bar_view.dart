...
import 'package:greethy_application/ui/page/fitness_app/models/tabIcon_data.dart';
                      ...
                      child: Padding(
                        ...
                        child: Row(
                          children: <Widget>[
                            ...
                            SizedBox(
                              width: Tween<double>(begin: 0.0, end: 1.0).animate(CurvedAnimation(parent: animationController!, curve: Curves.fastOutSlowIn)).value * 64.0,
                            ),
                            Expanded(
                              child: TabIcons(
            ...
            child: Stack(
              ...
              children: <Widget>[
                ScaleTransition(
                  ...
                  child: Image.asset(
                    widget.tabIconData!.isSelected ? widget.tabIconData!.selectedImagePath : widget.tabIconData!.imagePath,
                  ),
                ),
                Positioned(
                  top: 4,
